...
class APPTestCase(TestCase):
    ...
    @mock.patch('siteapi.v1.serializers.app.SAMLAPPSerializer.write_xml')
    ...
    def test_create_app(
        ...
        res = res.json()
        self.assertIn('entity_id', res['saml_app'])
        self.assertIn('acs', res['saml_app'])
        self.assertIn('sls', res['saml_app'])
