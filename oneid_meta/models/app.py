...
class SAMLAPP(BaseModel):
    ...
    app = models.OneToOneField('oneid_meta.APP',
                               ...
                               blank=True,
                               on_delete=models.CASCADE)
    entity_id = models.CharField(max_length=255, blank=True, verbose_name='SP方entity_id', unique=True)
    ...
    metapath = models.CharField(max_length=1024, blank=True, unique=True, verbose_name='本地SP元数据地址')
